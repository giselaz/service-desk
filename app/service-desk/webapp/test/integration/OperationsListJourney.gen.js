...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("OperationsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheOperationsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheOperationsListGenerated.onFilterBar().iChangeSearchField("Search Term");
